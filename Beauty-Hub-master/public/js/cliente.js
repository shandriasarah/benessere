  ...
  clients.forEach((c) => {
    ...
    tr.querySelector(".delete").onclick = () => {
      if (confirm("Deseja excluir este cliente?")) {
        clients = clients.filter((cli) => cli !== c);
        saveClients();
      }
    };
    tr.querySelector(".anamnese").onclick = () => {
      editingAnamnese = c;
      openAnamneseModal(c);
    };
  });
...
function openAnamneseModal(c) {
  ...
  document.getElementById("anamnesisTreatment").value =
    c.anamnese?.treatment || "";
  document.getElementById("anamnesisPast").value =
    c.anamnese?.pastProcedures || "";
  document.getElementById("anamnesisObservations").value =
    c.anamnese?.observations || "";
  document.getElementById("anamnesisLastVisit").value =
    c.anamnese?.lastVisit || "";
  document.getElementById("anamnesisFrequency").value =
    c.anamnese?.frequency || "";
...
document.getElementById("anamnesisCancel").onclick = () => {
